...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/18 09:21:20 by humartin          #+#    #+#             */
/*   Updated: 2022/08/18 09:21:21 by humartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initialisation(t_data *data)
{
	...
	data->mlx_win = mlx_new_window(data->mlx,
			dimension.x * 16,
			dimension.y * 16, "so_long");
	data->img = mlx_new_image(data->mlx,
			dimension.x * 16 - dimension.x, dimension.y * 16 - dimension.y);
